...
export const ProductForm:React.FC<ProductFormProps> = ({
    ...
    // @ts-ignore
    const form = useForm<ProductFormValues>({resolver:zodResolver(formSchema),defaultValues:initialData ? {
        ...initialData,
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <div className="grid grid-cols-3 gap-8">
                        <FormField control={form.control} name="name" render={({field})=>(
                         ...
                         <FormField control={form.control} name="price" render={({field})=>(
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type={"number"} placeholder='RS:-199' disabled={loading} {...field}/>
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}/>
                        ...
                        <FormField control={form.control} name="isArchieved" render={({field})=>(
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                <FormControl>
                                    <Checkbox checked={field.value}
                                              onCheckedChange={field.onChange}/>
                                    ...
                                    <div className="space-y-1 leading-none">
                                        ...
                                        <FormDescription>
                                            This Product will appear not appear on Store
                                        </FormDescription>
                                    </div>
                            </FormItem>
                        )}/>
